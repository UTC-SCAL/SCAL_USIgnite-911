...
#     grid_section1.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S1 Daily Avg Temps.csv")
# # A final save
# grid_section1.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S1 Daily Avg Temps.csv")
# exit()
...
average_file = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S4 Monthly Avg Temps.csv")
# Set the range of column values you want to go over
for i in range(1369,1826):
    ...
    average_file.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S4 Monthly Avg Temps2.csv")
average_file.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S4 Monthly Avg Temps2.csv")