...
def fitting_loops(X,Y):
    ...
    for i in range(0, 50):
        file = "../Excel & CSV Sheets/Grid Layout Test Files/" + str(datetime.date.today()) + "GridTemporalAverageHolder.csv"
        ...
        if exists('model_grid_temporal.h5'):
            model.load_weights("model_grid_temporal.h5")
        ...
        model.save_weights("model_grid_temporal.h5")
...
#           1. Load Data
dataset = pandas.read_csv("../Excel & CSV Sheets/Grid Layout Test Files/Grid Data.csv", sep=",")
