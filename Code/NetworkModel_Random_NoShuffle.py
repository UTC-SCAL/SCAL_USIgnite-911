...
def fitting_loops(dataset, testing, folder):
    ...
    for i in range(0, 50):
        ...
        if exists(folder + 'model_Random_NoShuffle.h5'):
            model.load_weights(folder + "model_Random_NoShuffle.h5")
...
folder = "../Graphs & Images/ResultsFromRandomTesting/First Test - No Shuffle/"
#           Shuffling if needed. 
