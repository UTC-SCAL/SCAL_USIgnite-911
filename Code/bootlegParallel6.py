...
negative_samples = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/NS True Master List.csv")
...
for i, values in enumerate(negative_samples.values):
    ...
    if i % 1000 ==0:
        negative_samples.to_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/NS True Master List Matched.csv")
negative_samples.to_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/NS True Master List Matched.csv")