...
def fitting_loops(X,Y):
    ...
    for i in range(0, 50):
        file = "../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/" + str(datetime.date.today()) + "GridAverageHolder.csv"
...
def generate_results(y_test, predictions, hist, fpr, tpr, roc_auc,i):
    ...
    title = '../Graphs & Images/ResultsFromGridOSIterations/' + str(datetime.datetime.today()) + 'roc' + str(i) + '.png'
    ...
    title = '../Graphs & Images/ResultsFromGridOSIterations/' + str(datetime.datetime.today()) + 'pred' + str(i) + '.png'
    fig.savefig(title, bbox_inches='tight')
    ...
    # plt.show()
    title = '../Graphs & Images/ResultsFromGridOSIterations/' + str(datetime.datetime.today()) + 'lossandacc' + str(
        i) + '.png'
    fig.savefig(title, bbox_inches='tight')
