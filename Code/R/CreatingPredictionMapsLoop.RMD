...
title = "../../Excel & CSV Sheets/Forecasts/01-23-2020/Hex/Forecast/Dayframe Testing/SecondTest_GridFix_75-25 Split_Forecast.csv"
...
model  = str_split(str_split(title, "/")[[1]][9], "_Forecast.csv")[[1]][1]
model = gsub("_", " ", model)
