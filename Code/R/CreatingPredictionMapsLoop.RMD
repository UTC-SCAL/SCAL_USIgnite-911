...
model = gsub("_", " ", model)
for(frame in dayframes){
  savename = paste("../../Excel & CSV Sheets/Forecasts/",titledate,"/Hex/Viz/DayFrame Testing/Grid Fix Predictions/PredictionMapfor_",titledate, "_",model,"_DayFrame",frame,".png",sep="")
