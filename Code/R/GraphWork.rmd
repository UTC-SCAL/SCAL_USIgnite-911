...
png("AllAccidentsWeekdayHourSplit_New.png", width=12,height=6,units='in', res=300,bg = 'transparent')
...
png("AllAccidentsYearHourSplitExplainedNew.png", width=12,height=6,units='in', res=300,bg = 'transparent')
...
names(monthtab)
png("AllAccidentsMonthHourSplitNew.png", width=12,height=6,units='in', res=300,bg = 'transparent')
...
png("AllAccidentsHourSplitNew.png", width=12,height=6,units='in', res=300,bg = 'transparent')
...
png("AllAccidentsYearMonthSplitNew.png", width=12,height=6,units='in', res=300,bg = 'transparent')
...
lines(yearlymonthtab$Freq[25:35], col='red', lwd=4)
legend("topleft",c('2017','2018', '2019'), fill=c('blue','green', 'red'))
dev.off()
```
