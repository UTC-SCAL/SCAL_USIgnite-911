...
png("AllAccidentsWeekdayHourSplit_New.png", width=12,height=6,units='in', res=300)
...
png("AllAccidentsYearHourSplitExplainedNew.png", width=12,height=6,units='in', res=300)
...
names(monthtab)
png("AllAccidentsMonthHourSplitNew.png", width=12,height=6,units='in', res=300)
plot(monthtab$January, type="l", ylim=c(0,900),col='#469990', lwd=4, ylab="Number of Accidents", xlab="Hour of Day", xlim=c(.5,24.5), xaxt="none", yaxt="none",main="Accidents by Month and Hour")
axis(1, c(1,7,13,19,24), c(0,6,12,18,23),las="2")
axis(2,las="2")
...
png("AllAccidentsHourSplitNew.png", width=12,height=6,units='in', res=300)
...
png("AllAccidentsYearMonthSplitNew.png", width=12,height=6,units='in', res=300)
