...
accidents = pandas.read_csv("Excel & CSV Sheets/ChattaData Accident System/ChattaDataAccidentsEtrims.csv")
...
# accidents.to_csv("Excel & CSV Sheets/ChattaData Accident System/ChattaDataAccidents.csv", index=False)
...
accidents.to_csv("Excel & CSV Sheets/ChattaData Accident System/ChattaDataAccidentsComplete.csv", index=False)
exit()
