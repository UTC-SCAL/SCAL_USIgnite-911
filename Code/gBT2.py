...
# grid_section2 = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S2 Daily Avg Temps.csv")
...
# Grid Blocks 276 - 550
# Grid OS Blocks 457 - 912
grid_averages = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S2 Monthly Avg Temps.csv")
grid_section = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S2 Daily Avg Temps.csv")
# Grid Blocks 551 - 825
...
for i in range(893,913):
    ...
    grid_averages.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S2 Monthly Avg Temps.csv")
grid_averages.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S2 Monthly Avg Temps.csv")
