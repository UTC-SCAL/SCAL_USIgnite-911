...
negative_samples = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/GridFixed/NS GridFix Master List.csv")
...
weather_section1 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_0_50_Full.csv")
weather_section2 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_50_100_Full.csv")
weather_section3 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_100_150_Full.csv")
weather_section4 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_150_200_Full.csv")
weather_section5 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_200_250_Full.csv")
weather_section6 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_250_300_Full.csv")
weather_section7 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_300_350_Full.csv")
weather_section8 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_350_400_Full.csv")
weather_section9 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_400_450_Full.csv")
weather_section10 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_450_500_Full.csv")
weather_section11 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_500_550_Full.csv")
weather_section12 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_550_600_Full.csv")
weather_section13 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_600_650_Full.csv")
weather_section14 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_650_700_Full.csv")
weather_section15 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_700_750_Full.csv")
weather_section16 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_750_800_Full.csv")
weather_section17 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_800_850_Full.csv")
weather_section18 = pandas.read_csv("../Excel & CSV Sheets/WeatherWork/ALLWeather_850_906_Full.csv")
...
for i, values in enumerate(negative_samples.values):
    ...
    try:
        ...
        print("Couldn't Match Block")
    if i % 1000 ==0:
        negative_samples.to_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/NS_GridFix_Master_List_Matched.csv")
negative_samples.to_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/NS_GridFix_Master_List_Matched.csv")