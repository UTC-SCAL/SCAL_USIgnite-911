...
def fitting_loops(X, Y):
    ...
    for i in range(0, 50):
        file = "../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/True Randoms/" + str(datetime.date.today()) + "TrueRandomAverageHolder.csv"
        ...
        if exists('../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/True Randoms/model_TrueRandom.h5'):
            model.load_weights("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/True Randoms/model_TrueRandom.h5")
        ...
        model.save_weights("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/True Randoms/model_TrueRandom.h5")
...
def generate_results(y_test, predictions, hist, fpr, tpr, roc_auc, i):
    ...
    title = '../Graphs & Images/ResultsFromTrueRandomTesting/First Test - Double shuffle/' + str(datetime.datetime.today()) + 'roc' + str(i) + '.png'
    ...
    title = '../Graphs & Images/ResultsFromTrueRandomTesting/First Test - Double shuffle/' + str(datetime.datetime.today()) + 'pred' + str(i) + '.png'
    fig.savefig(title, bbox_inches='tight')
    ...
    # plt.show()
    title = '../Graphs & Images/ResultsFromTrueRandomTesting/First Test - Double shuffle/' + str(datetime.datetime.today()) + 'lossandacc' + str(
        i) + '.png'
    fig.savefig(title, bbox_inches='tight')
...
#           1. Load Data
dataset = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/True Randoms/True Random Data 2017+2018_ModelReady.csv", sep=",")
...
X = dataset.ix[:, 2:(len(dataset.columns) + 1)].values
print(X[0:5])
