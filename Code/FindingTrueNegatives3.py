...
negatives = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/NS Master List 3.csv",index_col=False)
...
for i, info in enumerate(negatives.values):
    ...
    if no_matches is True:
        ...
        neg_loc += 1
    if i % 500 == 0:
        negative_samples.to_csv("../Excel & CSV Sheets/Grid Oriented Layout Test Files/NegativeSampling/NS True Master List 3.csv", index=False)
