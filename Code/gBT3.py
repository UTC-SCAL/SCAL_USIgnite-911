...
# Grid Blocks 276 - 550
# Grid OS Blocks 457 - 912
grid_averages = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S3 Monthly Avg Temps.csv")
grid_section = pandas.read_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S3 Daily Avg Temps.csv")
# Grid Blocks 551 - 825
...
for i in range(913,1369):
    ...
    grid_averages.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S3 Monthly Avg Temps.csv")
grid_averages.to_csv("../Excel & CSV Sheets/Grid Oriented Small Layout Test Files/Grid OS Blocks S3 Monthly Avg Temps.csv")
