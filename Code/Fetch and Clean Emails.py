...
def main():
    ...
    total = pandas.read_csv("../Main Dir/Accident Data/EmailAccidentData_02-01-21.csv")
    ...
    total.to_csv("../Main Dir/Accident Data/EmailAccidentData_NewFetch.csv", index=False)
    ...
    fetchedAccidents = pandas.read_csv("../Main Dir/Accident Data/EmailAccidentData_NewFetch.csv")
    # The file containing our cleaned list of raw accident records
    cleanedAccidents = pandas.read_csv("../Main Dir/Accident Data/EmailAccidentData_02-01-21.csv")
