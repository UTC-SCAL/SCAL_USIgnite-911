...
forecast = read.csv("../Excel & CSV Sheets/Grid Layout Test Files/Forecast-for5-14-2019_2019-05-14_12.csv", header=TRUE)
forecast = forecast[which(forecast$Prediction==1),]
...
ggmap(cda, legend = "bottom") +
  xlim(lons)+ylim(lats)+theme_minimal(base_size = 22)+
  labs(x="",y="", title="Accidents in Chattanooga - Early Morning") +
