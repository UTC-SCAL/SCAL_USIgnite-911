...
weather_holder = pandas.read_csv(
    "../Excel & CSV Sheets/2019 Data/2019 Weather Dates 2.csv")
miss_loc = 0
...
for stuff, i in enumerate(blocks.columns.values):
    ...
    if 599 >= i >= 315:
        ...
        weather_holder.to_csv \
            ("../Excel & CSV Sheets/2019 Data/2019 Weather Dates2 Part 2.csv",
             index=False)

weather_holder.to_csv \
    ("../Excel & CSV Sheets/2019 Data/2019 Weather Dates2 Part 2.csv", index=False)