...
negative_samples = pandas.read_csv("../Excel & CSV Sheets/2019 Data/Negative Samples/2019 Sys Negatives Blocks 401 - 599.csv")
...
for i, values in enumerate(negative_samples.values):
    ...
    if 400 <= negative_samples.Grid_Block.values[i] <= 499:
    ...
    if i % 1000 == 0:
        negative_samples.to_csv(
            "../Excel & CSV Sheets/2019 Data/Negative Samples/2019 Sys Negatives Blocks 401 - 599 Matched.csv")
negative_samples.to_csv("../Excel & CSV Sheets/2019 Data/Negative Samples/2019 Sys Negatives Blocks 401 - 599 Matched.csv")