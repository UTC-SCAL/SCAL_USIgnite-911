...
# gridCoords.to_csv("../Excel & CSV Sheets/Grid Layout Test Files/VerticesPoints 2.csv")
        

# Checking to see what calldata records each grid block has #
# calldata = pandas.read_csv("../Excel & CSV Sheets/New Data Files/New Negative Samples (Location).csv", sep=",")
...
#         else:
#             pass
# calldata.to_csv("../Excel & CSV Sheets/New Data Files/New Negative Samples (Location).csv")
