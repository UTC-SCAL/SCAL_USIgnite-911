...
negative_samples = pandas.read_csv("../Excel & CSV Sheets/2019 Data/Negative Samples/2019 Sys Negatives Blocks 603 - 799.csv")
...
# weather_section9 = pandas.read_csv("../Excel & CSV Sheets/2019 Data/Weather2019_800_906_Full.csv")
...
for i, values in enumerate(negative_samples.values):
    ...
    if 600 <= negative_samples.Grid_Block.values[i] <= 699:
    ...
    if i % 1000 == 0:
        negative_samples.to_csv(
            "../Excel & CSV Sheets/2019 Data/Negative Samples/2019 Sys Negatives Blocks 603 - 799 Matched.csv")
negative_samples.to_csv("../Excel & CSV Sheets/2019 Data/Negative Samples/2019 Sys Negatives Blocks 603 - 799 Matched.csv")